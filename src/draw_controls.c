...
{
	int	n = W / 10;
	put_text_justified(fractol, n, H - 16, "Change fractal: [1-0]");
	put_text_justified(fractol, n * 3, H - 16, "Zoom: scroll up/down");
	put_text_justified(fractol, n * 5, H - 16, "Change patron: p");
	put_text_justified(fractol, n * 6.5, H - 16, "More/Less iterations: +/-");
	put_text_justified(fractol, n * 9, H - 16, "Reset: r");
